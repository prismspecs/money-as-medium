...
+ Wednesday
  + [Get on Slack](https://join.slack.com/t/graysonearle/shared_invite/enQtNzIzODQ4MjczNjUwLTVkNjMxN2M0NTc4NTI2MWM4NmVmNDhiNTEwMDc5YWUxYzgyNDljMTIyY2FhZGRkYjlhMWM4MTVlNTExZmYyYWM)!
  + Check-in
  + [Slides](https://docs.google.com/presentation/d/1QzHcu_hFddfembA5b4-fdyi6mkrh45Cr2Wj6penNl8s/edit?usp=sharing)
    + [Some background on freeport art storage](https://youtu.be/CwuMY-_V4dc) - relevant to much of what Hito Steyerl is writing about
    + [Forensic Architecture - Triple Chaser](https://forensic-architecture.org/investigation/triple-chaser) - in thinking of contemporary institutional critique
  + Discuss Text(s)
